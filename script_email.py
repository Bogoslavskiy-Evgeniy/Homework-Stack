...
class Send_receive_email:
    ...
    def receive_email(self, header):
        ...
        data = mail.uid('search', None, criterion) assert data[0]
...
email_s_r = Send_receive_email(login, password)
email_s_r.send_email(recipients, subject, message)
email_s_r.receive_email(header)